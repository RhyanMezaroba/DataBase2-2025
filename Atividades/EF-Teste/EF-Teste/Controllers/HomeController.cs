...
namespace EF_Teste.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, IStudentRepository studentRepository) // ILogger = Interface de registro de logs
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Update(Student stundent)
        {
            if (ModelState.IsValid)
            {
